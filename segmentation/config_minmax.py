...
PATH_DIR = '/mnt/parscratch/users/aca20whc/output/segmentation/detectdata/holdout_minmax/data_2d'
PATH_LIST = glob.glob(os.path.join(PATH_DIR,'*.hdf5'))
PATH_AP = '/mnt/parscratch/users/aca20whc/output/segmentation/detectdata/holdout_minmax/data_3d'
